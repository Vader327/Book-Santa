      ...
      <View style={{height: '100%'}}>
        ...
        <KeyboardAvoidingView behavior="padding" enabled style={{height: '100%'}}>
          <ScrollView style={{height: '100%'}}>
            ...
            <Input inputContainerStyle={styles.input} placeholder="First Name"
            ...
            <Input inputContainerStyle={styles.input} placeholder="Contact" keyboardType="number-pad" maxLength={10}
            onChangeText={(text)=>{this.setState({contact: text})}} value={this.state.contact} />

            <Input inputContainerStyle={styles.input} placeholder="Address" multiline={true}
