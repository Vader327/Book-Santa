		...
		return (
			<KeyboardAvoidingView behavior="padding" enabled style={{flex: 1, height: '100%', backgroundColor: '#f8be85'}}>
				...
				<View style={{alignItems:'center'}}>
					<BookSanta />
					<Text style={{fontSize:RFValue(35), fontWeight:'600', paddingBottom:30, color:'#ff3d00'}}>Book Santa</Text>
				</View>

				<View>
					<Input inputContainerStyle={[styles.input, {marginTop: 0}]} placeholder="Email" placeholderTextColor = "#ffff"
					onChangeText={(text)=>{this.setState({username: text})}}
					keyboardType="email-address" />

					<Input inputContainerStyle={[styles.input, {marginTop: 0}]} placeholder="Password" placeholderTextColor = "#ffff"
					onChangeText={(text)=>{this.setState({password: text})}}
