    ...
    return(
      <View style={{flex: 1}}>
        ...
        <View style={styles.logOutContainer}>
          <View style={{height: 2, width: '90%', backgroundColor: "#dddddd", alignSelf: 'center'}} />
          <TouchableOpacity style={styles.logOutButton}
          onPress={()=>{
            this.props.navigation.navigate("WelcomeScreen");
            firebase.auth().signOut();
          }}>
            <Ionicons name="md-log-out" size={20} color="#696969" />
            <Text style={{fontWeight: '700', marginLeft: 36}}>Log Out</Text>
          </TouchableOpacity>
        </View>
      </View>
    )
